      ...
      axios.post(url, body).then(async (response) => {
       ...
       // sessionStorage.setItem("userEmail", email)
        ...
        if (
          ...
          console.log("user details" + response.data.userType);
          ...
          <div className="signin1 col-md-4 ">
            <div className="form">
              ...
              <div className="mb-3">
                ...
                />
              {(!emailValidation) ? <div className="text-danger">{emailErr}</div> : <div className="text-success"> </div>}
              ...
              <div className="mb-3">
                ...
                <input
                  ...
                  className="form-control"
                ></input>
                {(!passwordValidation) ? <div className="text-danger">{passErr}</div> : <div className="text-success"> </div>}
